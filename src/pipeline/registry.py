...
STAGES: list[Stage] = [
    ...
    Stage(
        "circular_connectome",
        "Circular Connectome Visualization",
        "src.analysis.circular_connectome",
        RESULTS_DIR / "paper_figures" / "circular_connectome_ASD.png",
        dependencies=["causal_graphs"],
    ),
    Stage(
        "brain_3d_visualization",
        "3D Brain Visualization (Nilearn)",
        "src.analysis.brain_3d_visualization",
